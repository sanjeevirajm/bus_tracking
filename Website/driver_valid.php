...
if($routeno!=null)
{
$sql = "update driver set froms='$froms', tos='$tos', busno='$busno', time='$starttime', routeno='$routeno', tripno='$tripno', startedtime='$startedtime' where id='$id' ";
$result = mysqli_query($con,$sql) or die(mysql_error());

$sql = "update schedule set startedtime='$startedtime', did='$id' where routeno='$routeno' and tripno='$tripno' ";
$result = mysqli_query($con,$sql) or die(mysql_error());
echo "<br>";echo "DATA INSERTED"; echo "<br>";
echo "<a href='http://bustracking.site50.net/track_driver.html'> Start tracking</a>";
}
else
{
	echo "Error occured";
